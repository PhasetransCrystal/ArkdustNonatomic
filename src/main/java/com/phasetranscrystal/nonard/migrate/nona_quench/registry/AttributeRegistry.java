...
public class AttributeRegistry {
    ...
    public static final DeferredHolder<Attribute, Attribute>
            CRITICAL_CHANCE = regs("critical_chance", 0, 0, 1),      //暴击率
    ...
    //枪械
    public static final DeferredHolder<Attribute, Attribute>
            SHOOTING_SPEED = regs("shooting_speed", 0, 0, 1200, "range_weapon"),                     //射击速度(次/分钟)
            RELOADING_TIME = regs("reloading_time", 0, "range_weapon"),                                         //换弹速度(秒)
            DISPERSION_SPEED = regs("dispersion_speed", 0.02, "range_weapon"),                                  //散布初速度 为子弹添加垂直于发射路径的初速度模拟散布 TODO 数值待定
            STABILITY = regs("stability", 0.5, "range_weapon"),                                                 //稳定性 TODO 表现效果待定
            SQUATTING_DISPERSION = regs("squatting_dispersion_factor", 0.5,0,1, "range_weapon"),     //蹲姿散布因子 蹲下时散布初速度将乘以这个值
            STABILITY_FACTOR = regs("stability_factor", 0.5,0,1, "range_weapon"),                    //蹲姿稳定因子 蹲下时稳定性将乘以这个值
            ATTENUATION_START = regs("attenuation_start", 0,"range_weapon"),                                    //衰减起始距离 在这一距离后子弹将开始衰减
            ATTENUATION_RATE = regs("attenuation_rate", 0,"range_weapon"),                                      //衰减速率 每单位距离伤害衰减的百分比
