...
import com.phasetranscrystal.nonard.migrate.nona_quench.core.IAssembleItem;
...
public class AssembleWeaponType<T extends Item & IAssembleItem<T>> implements IEquipType<T> {//TODO
